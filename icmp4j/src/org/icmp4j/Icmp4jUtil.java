...
public class Icmp4jUtil {
  ...
  // my attributes
  public static void setNativeBridge (final NativeBridge nativeBridge) { Icmp4jUtil.nativeBridge = nativeBridge; }
  ...
  public static void initialize () {
    ...
    synchronized (Icmp4jUtil.class) {
      ...
      try {
        ...
        // nativeBridge-specific processing
        if (nativeBridge == null) {

          // you did NOT already specify a NativeBridge, so deduce and create one ourselves
